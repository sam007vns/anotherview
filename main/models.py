...
class authors(models.Model):
	...
	pintrest_link=models.TextField()
...
class articles(models.Model):
	...
	publish_date = models.DateTimeField(default=timezone.datetime.now(),editable=False)
	...
	second_title_text_para1 = models.TextField(verbose_name="Title 2 Paragraph 1",blank=True,editable=False)
	second_title_text_para2 = models.TextField(verbose_name="Title 2 Paragraph 2",blank=True,editable=False)
	second_image = models.ImageField(upload_to='images/',blank=True,verbose_name="Second Image(optional)")
	third_title=models.TextField(verbose_name="Title 3",blank=True,editable=False)
	third_title_text_para1 = models.TextField(verbose_name="Title 3 Paragraph 1",blank=True,editable=False)
	third_title_text_para2 = models.TextField(verbose_name="Title 3 Paragraph 2",blank=True,editable=False)
	third_title_text_para3 = models.TextField(verbose_name="Title 3 Paragraph 3",blank=True,editable=False)
	third_title_text_para4 = models.TextField(verbose_name="Title 3 Paragraph 4",blank=True,editable=False)
	third_image = models.ImageField(upload_to='images/',blank=True,verbose_name="Third Image(optional)")
	third_title_text_key_point1 = models.TextField(verbose_name="Key-Point1(optional)",blank=True,editable=False)
	third_title_text_key_point2 = models.TextField(verbose_name="Key-Point2(optional)",blank=True,editable=False)
	third_title_text_key_point3 = models.TextField(verbose_name="Key-Point3(optional)",blank=True,editable=False)
	third_title_text_key_point4 = models.TextField(verbose_name="Key-Point4(optional)",blank=True,editable=False)
	third_title_text_key_point5 = models.TextField(verbose_name="Key-Point5(optional)",blank=True,editable=False)
	fourth_title = models.TextField(blank=True,verbose_name="Title 4(optional)",editable=False)
	fourth_title_text_para1 = models.TextField(blank=True,verbose_name="Title 4 Paragraph 1(optional)",editable=False)
	fourth_title_text_para2 = models.TextField(blank=True,verbose_name="Title 4 Paragraph 2(optional)",editable=False)
	fourth_title_text_para3 = models.TextField(blank=True,verbose_name="Title 4 Paragraph 3(optional)",editable=False)
